...
JNIEXPORT jlong JNICALL Java_com_airwen_recognizer_plate_PlateRecognizer_initPR(JNIEnv *env, jclass instance, jstring svmpath, jstring annpath) {
...
JNIEXPORT jlong JNICALL Java_com_airwen_recognizer_plate_PlateRecognizer_uninitPR(JNIEnv *env, jclass instance, jlong recognizerPtr) {
...
JNIEXPORT jbyteArray JNICALL Java_com_airwen_recognizer_plate_PlateRecognizer_plateRecognize(JNIEnv *env, jclass instance, jlong recognizerPtr, jstring imgpath) {
    CPlateRecognize *pr = (CPlateRecognize *)recognizerPtr;
